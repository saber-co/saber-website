...
const features = [
  ...
  },
  {
    ...
    description: "OpenClaw navigates web apps, fills forms, pulls data, and completes repetitive browser tasks your team shouldn't be doing.",
    image: "/capabilities/sop.svg",
    area: "d",
  },
  {
    title: "Automated follow-ups",
    description: "No lead goes cold. OpenClaw sends timely follow-up emails, SMS, and Slack nudges based on your playbook.",
    image: "/capabilities/reporting.svg",
    area: "e",
  },
  {
    title: "Human-in-the-loop approvals",
    description: "OpenClaw handles the work, but your team stays in control. Approval checkpoints for anything that needs a human call.",
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between md:gap-6">
          <div>
            ...
            <h2 className="mt-3 text-balance text-3xl font-semibold tracking-tight text-white md:text-4xl">
              We implement OpenClaw in your environment, configured for your team.
            </h2>
