...
const tweetsTop: Tweet[] = [
  ...
  },
  {
    handle: "@openclaw",
    name: "OpenClaw 🦞",
    text: "OpenClaw 2026.2.24 🦞  Stop phrases in 10+ languages, typing indicators, PowerShell 7 support, and a big security hardening pass.",
    likes: 1823,
    reposts: 150,
  ...
  },
  {
    handle: "@openclaw",
    name: "OpenClaw 🦞",
    text: "OpenClaw 2026.2.22 🦞  Mistral support, multilingual memory, cron parallel runs, and a browser extension for your own Chrome tabs.",
    likes: 3683,
    reposts: 324,
  ...
  },
  {
    handle: "@openclaw",
    name: "OpenClaw 🦞",
    text: "OpenClaw 2026.2.21  Gemini 3.1 support, Discord streaming + voice channels, thread-bound subagent sessions, and large security hardening improvements.",
    likes: 7353,
    reposts: 612,
...
const tweetsBottom: Tweet[] = [
  ...
  },
  {
    handle: "@openclaw",
    name: "OpenClaw 🦞",
    text: "OpenClaw 2026.2.19  Apple Watch MVP, gateway auth and device management, OTEL v2 migration, and 40+ security fixes.",
    likes: 5534,
    reposts: 457,
  ...
  },
  {
    handle: "@openclaw",
    name: "OpenClaw 🦞",
    text: "OpenClaw 2026.2.17 just dropped: Sonnet 4.6, 1M context beta, spawn subagents from chat, and better session orchestration.",
    likes: 5323,
    reposts: 457,
    url: "https://x.com/openclaw/status/2023961490970026163",
  },
  {
    handle: "@jakubkrcmar",
    name: "Jakub Krcmar",
  ...
  },
  {
    handle: "@openclaw",
    name: "OpenClaw 🦞",
    text: "OpenClaw 2026.2.15 is here: Telegram message streaming, Discord Components v2, nested subagents, and major security hardening.",
    likes: 7022,
    reposts: 577,
