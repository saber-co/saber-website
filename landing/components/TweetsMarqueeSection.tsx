...
const tweetsTop: Tweet[] = [
  ...
  },
  {
    handle: "@sarahfoundr",
    name: "Sarah Mitchell",
    text: "Replaced 3 separate tools with one OpenClaw workflow. My ops team went from reactive firefighting to actually building.",
    likes: 891,
    reposts: 203,
  },
  {
...
const tweetsBottom: Tweet[] = [
  ...
  },
  {
    handle: "@lisa_revenue",
    name: "Lisa Okonkwo",
    text: "OpenClaw picked up our after-hours calls and booked 12 demos while we slept. Literally paid for itself in a week.",
    likes: 734,
    reposts: 189,
  },
  {
